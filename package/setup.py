...
setup(name = 'peptidesim',
      ...
      license = 'GPL3',
      packages = ['peptidesim'],
      install_requires=['PeptideBuilder@https://api.github.com/repos/mtien/PeptideBuilder/tarball/master', 'GromacsWrapper', 'dill', 'traitlets', 'requests', 'future', 'pytest', 'biopython'],
      test_suite='tests',
      zip_safe=True,
