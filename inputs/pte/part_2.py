...
# To calculate replica exchange efficiency from md.log
...
max_eds_iterations = 2
index_of_eds_file = max_eds_iterations - 1
...
for replica in range(replicas):
    eds_file_string += '{}/eds_bias_restart{}.{}.dat,'.format(
...
plumed_input1 = textwrap.dedent(
    ...
    ENDPLUMED
    '''.format(total_no_atoms, eds_period, '{' + temps + '}', os.getcwd(), index_of_eds_file, '{' + eds_file_string + '}'))
